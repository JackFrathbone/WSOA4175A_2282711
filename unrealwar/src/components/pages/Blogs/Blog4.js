...
export default class Blog4 extends Component {
  render() {
    return (
      <div className="blog">
        <h1>Blog 4: Self Reflection</h1>
        <p>
          With the first real version of my website now working, it seems
          appropriate to look back at the progress made, especially in light of
          what I want to achieve with this work overall. While it feels like
          progress has been a bit slow generally, my website has at least
          ...
          look at the role of U.S. imperialism and how it relates to the
          internet, particularly the depiction of violence and the American
          military online. So far my focus has been on the visual side, making a
          connection between the symbol of American military power that is the
          javelin weapon system and my website's aesthetic. I have been very
          inspired to pursue this whole angle by the book Cyborg Worlds: the
          ...
          theoretically, with my last blogpost touching a bit on this topic. I
          hope to use the next stages of my website to really dig into this
          question and make a piece of netart that helps to showcase this
          problem. With a bulk of the practical website building busywork out of
          the way I hopefully can spend more time fully engaging with the
          theory.
        </p>
        <h2>References</h2>
        <p>
